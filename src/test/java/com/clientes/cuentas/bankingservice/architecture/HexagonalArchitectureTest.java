...
public class HexagonalArchitectureTest {
   ...
   * application.pagination contains application pagination models/utilities.
   * API DTOs (with OpenAPI/Swagger annotations) must live in infrastructure packages.
   */
  @ArchTest
   ...
   * The DTOs generated by OpenAPI can reside in infrastructure.input.dto and infrastructure.pagination.
   */
  @ArchTest
   ...
   * application.pagination contains only application-side pagination abstractions.
   */
  @ArchTest
